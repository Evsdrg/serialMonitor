...
class I18N:
    ...
    TEXTS: dict[str, dict[str, str]] = {
        "zh": {
            ...
            "quick_send_queued_hex": "[快捷发送已入队HEX] {}",
            "quick_send_queued_ascii": "[快捷发送已入队] {}",
            "send_error": "[错误] 发送失败: {}",
            ...
            "paste_confirm": "已粘贴 {} 行，再次 Ctrl+Shift+V 确认发送",
...
""",
        ...
        "en": {
            ...
            "quick_send_queued_hex": "[Quick Send Queued HEX] {}",
            "quick_send_queued_ascii": "[Quick Send Queued] {}",
            ...
            "paste_confirm": "Pasted {} lines, press Ctrl+Shift+V again to send",
